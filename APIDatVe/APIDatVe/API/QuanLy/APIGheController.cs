                    ...
                    using (var transaction = db.Database.BeginTransaction())
                    {
                        ...
                        _gheXe.GheTang1.ForEach(x =>
                        {
                            x.Ghes.ForEach(y =>
                            {
                                ...
                                {
                                    Ghe ghe = db.Ghes.FirstOrDefault(z => z.tang == 1 && z.vitriX == y.vitriX && z.vitriY == y.vitriY);
                                    if (ghe == null)
                                    {
                                        db.Ghes.Add(new Ghe()
                                        {
                        ...
                        _gheXe.GheTang2.ForEach(x =>
                        {
                            x.Ghes.ForEach(y =>
                            {
                                if (!string.IsNullOrEmpty(y.maghe))
                                {
                                    Ghe ghe = db.Ghes.FirstOrDefault(z => z.tang == 2 && z.vitriX == y.vitriX && z.vitriY == y.vitriY);
                                    if (ghe == null)
                                    {
                                        db.Ghes.Add(new Ghe()
                                        {
